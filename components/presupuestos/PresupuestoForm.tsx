...
import { LineasFactura } from "@/components/facturas/LineasFactura"
import type {
    Presupuesto,
    Cliente,
    Producto,
    LineaPresupuestoFormData,
    LineaFacturaFormData,
} from "@/types"

interface PresupuestoFormProps {
    presupuesto?: Presupuesto & { lineas?: { id: string; producto_id: string | null; descripcion: string; cantidad: number; precio_unitario: number; igic: number; subtotal: number }[] }
    clientes: Cliente[]
    productos: Producto[]
    onCancel?: () => void
}
...
export function PresupuestoForm({
    ...
    const [fecha, setFecha] = useState(
        presupuesto?.fecha || new Date().toISOString().split("T")[0]
    )
        ...
        try {
            if (isEditing) {
                ...
                toast({
                    ...
                    description: `Presupuesto ${finalNumero} creado correctamente`,
                    variant: "success",
                })
            }
            ...
            console.error("Error creating/updating presupuesto:", error)
            ...
            <Card>
                ...
                <CardContent className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">
                            Dejar vacío para autogenerar (ej: P2601)
                        </p>
                    </div>
                </CardContent>
            </Card>
